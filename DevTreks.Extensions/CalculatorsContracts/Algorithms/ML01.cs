...
namespace DevTreks.Extensions.Algorithms
{
    ...
    public class ML01 : MLBase
    {
        ...
        static int[][][] MakeJointCounts(List<List<string>> trainData,
            string[][] attributeValues)
        {
            ...
            for (int i = 1; i < attributeValues.Length; ++i)
            {
                ...
                {
                    int iLabelIndex = AttributeValueToIndex(trainData[k][0], attributeValues);
                    int iFeatureIndex = 0;
        ...
        {
            int iLabelIndex = AttributeValueToIndex(label, attributeValues);
            int iFeatureIndex = 0;
