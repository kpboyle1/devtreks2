    ...
    public class ML01 : MLBase
    {
                ...
                List<List<string>> rowNames, List<List<string>> data2)
        {
            ...
            try
            {
                ...
                StringBuilder sResults = Main(args);
        ...
        static StringBuilder Main(string[] args)
        {
            StringBuilder sb = new StringBuilder();
            try
            {
                sb.AppendLine("\nBegin Naive Bayes Classification demo\n");
                sb.AppendLine("Demo will classify sex based on occpation, dominance, height\n");
                ...
                sb.AppendLine("Generating 40 lines of occupation, dominance, height, sex data\n");
                ...
                sb.AppendLine("Converting numeric height data to categorical data on 64.0 71.0\n");
                ...
                sb.AppendLine("Scanning binned data to compute joint and dependent counts\n");
        ...
        static int Classify(StringBuilder sb, string occupation, string dominance, string height, int[][][] jointCounts, int[] dependentCounts, bool withSmoothing, int xClasses)
        {
            ...
            sb.AppendLine("Probability of male   = " + probMale.ToString("F4"));
            sb.AppendLine("Probability of female = " + probFemale.ToString("F4"));
