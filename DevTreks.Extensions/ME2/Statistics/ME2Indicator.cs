...
namespace DevTreks.Extensions
{
    ...
    public class ME2Indicator : CostBenefitCalculator
    {
        ...
        private async Task<bool> SetCalculations()
        {
            ...
            //bool bHasCalculations = await SetCalculationsAsync(iIndicatorNumber)
        ...
        public async Task<bool> CalculateIndicators(int indicatorIndex)
        {
            ...
            if (indicatorIndex == 1)
            {
                    ...
                    && (ME2Indicators[1].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 1))
                    {
                        ...
                        {
                            await ProcessAlgosAsync3(indicatorIndex, ME2Indicators[1].IndURL);
                        }
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[1].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 2)
            {
                    ...
                    && (ME2Indicators[2].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 2))
                    {
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[2].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 3)
            {
                    ...
                    && (ME2Indicators[3].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 3))
                    {
                        ...
                        {
                            await ProcessAlgosAsync3(indicatorIndex, ME2Indicators[3].IndURL);
                        }
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[3].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 4)
            {
                    ...
                    && (ME2Indicators[4].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 4))
                    {
                        ...
                        {
                            await ProcessAlgosAsync3(indicatorIndex, ME2Indicators[4].IndURL);
                        }
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[4].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 5)
            {
                    ...
                    && (ME2Indicators[5].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 5))
                    {
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[5].IndURL);
                        }
            ...
            if (indicatorIndex == 6)
            {
                    ...
                    && (ME2Indicators[6].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 6))
                    {
                        ...
                        {
                            await ProcessAlgosAsync3(indicatorIndex, ME2Indicators[6].IndURL);
                        }
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[6].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 7)
            {
                    ...
                    && (ME2Indicators[7].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 7))
                    {
                        ...
                        {
                            await ProcessAlgosAsync3(indicatorIndex, ME2Indicators[7].IndURL);
                        }
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[7].IndURL);
                        }
                        else
                        {
            ...
            if (indicatorIndex == 8)
            {
                    ...
                    && (ME2Indicators[8].IndLabel != Constants.NONE))
                {
                    if (!_indicators.Any(o => o == 8))
                    {
                        ...
                        {
                            await ProcessAlgosAsync4(indicatorIndex, ME2Indicators[8].IndURL);
                        }
                        else
                        {
                ...
                && (ME2Indicators[0].IndMathExpression != Constants.NONE))
            {
                ...
                if (!_indicators.Any(o => o == 0))
                {
                    ...
                    {
                        await ProcessAlgosAsync3(indicatorIndex, DataURL);
                    }
                    ...
                    {
                        await ProcessAlgosAsync4(indicatorIndex, DataURL);
                    }
                    else
                    {
        ...
        private async Task<string> ProcessAlgoCorrAsync(string jdataURL, int dataIndex)
        {
            ...
            IDictionary<int, List<List<double>>> data = await GetDataSet1(dataIndex);
        ...
        private async Task <IDictionary<int, List<List<double>>>> GetDataSet1(int dataIndex)
        {
